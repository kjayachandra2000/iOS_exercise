...
class LoginDemoRxReduxTests: XCTestCase {
    ...
    func xtestSnapshot_LoggedOut_PasswordNotHidden_LoginButtonEnabled() {
    ...
    func xtestSnapshot_LoggedOut_PasswordHidden_LoginButtonDisabled() {
    ...
    func xtestSnapshot_PerformingLogin_LoginButtonDisabled() {
    ...
    func xtestSnapshot_LoginFailed_LoginButtonDisabled() {
    ...
    func xtestSnapshot_LoginFailed_LoginButtonEnabled() {
        let apiError = APIError.wrongCredentials
